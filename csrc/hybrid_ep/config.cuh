...
struct HybridEpConfigInstance {
  ...
  int num_of_nodes;
  int pad_multiple;
  int topk;  // 0 = sparse bool routing map; >0 = dense uint16 topk_idx mode
  ...
  // topk is already declared earlier in this struct (line 67) — reused for direct_permute addressing
